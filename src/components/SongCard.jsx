...
// prpos : {song, i}
function SongCard({song, data, i, isPlaying, activeSong}) {
  ...
  return (
    <div className='flex felx-col w-[250px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer'>
